...
const createTask = async (req, res) => {
    try {
        const { title, type, description, deadline, day } = req.body;

        const task = await Task.create({
            title, type, description, deadline, day
        });
...
module.exports = { getStats, createTask, getAllSubmissions, updateSubmissionStatus, getAllUsers, getAttendance, markAttendance };
